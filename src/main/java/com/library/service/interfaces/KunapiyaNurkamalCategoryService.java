...
public interface KunapiyaNurkamalCategoryService {
    ...
    KunapiyaNurkamalCategoryResponse createCategory(
            KunapiyaNurkamalCategoryRequest request
    );

    KunapiyaNurkamalCategoryResponse getCategoryById(
            Long id
    );

    List<KunapiyaNurkamalCategoryResponse> getAllCategories();

    KunapiyaNurkamalCategoryResponse updateCategory(
            Long id,
            KunapiyaNurkamalCategoryRequest request
    );
